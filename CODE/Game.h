...
string easyWords[30] =   {"ALA","CAE","DON","FEA","EMU","HAY","LEE","MIO","ORO","UVA","ARES","ADAN","BAÑO","COCO","GATO","HUBO","IZAS","LIMA","IBAN","BOYA","HUYAN","ACUÑA","ARCOS","AZOTE","BACAN","AYUDA","ARUÑO","BEBES","BORRE","BRUTA"};
